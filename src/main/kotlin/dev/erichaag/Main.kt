...
fun main() {
    ...
    val report = report {
        organization("spring-projects") {
            ...
            exclude(name = "spring-data-dev-tools", reason = "maintainers declined PR: https://github.com/spring-projects/spring-data-dev-tools/pull/222")
            ...
            exclude(name = "spring-data-release", reason = "maintainers declined PR: https://github.com/spring-projects/spring-data-release/pull/68")
